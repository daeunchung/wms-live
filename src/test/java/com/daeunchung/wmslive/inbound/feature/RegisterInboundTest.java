...
class RegisterInboundTest {
    ...
    void registerInbound() {
        ...
        final LocalDateTime estimatedArrivalAt = LocalDateTime.now();
        ...
        final RegisterInbound.Request.Item inboundItem = new RegisterInbound.Request.Item(
                productNo, quantity, unitPrice, "description"
        );
        ...
        RegisterInbound.Request request = new RegisterInbound.Request(
                "title", "description", orderRequestedAt, estimatedArrivalAt, inboundItems
        );
        ...
        public record Request(String title, String description, LocalDateTime orderRequestedAt,
            ...
            public record Item(Long productNo, Long quantity, Long unitPrice, String description) {
                public Item {
                    ...
                    Assert.notNull(unitPrice, "입고 요청일은 필수입니다");
                    if (0 > unitPrice) {
